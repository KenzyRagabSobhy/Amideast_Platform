...
def py():
    ...
    icon=PhotoImage(file='photosk\\mm.png')
    ...
    def first():
        subprocess.Popen(["notepad.exe","photosk\\lecture1.txt"])
    def second():
        subprocess.Popen(["notepad.exe","photosk\\lecture2.txt"])
    def third():
        subprocess.Popen(["notepad.exe","photosk\\lecture3.txt"])
    def fou():
        n=Toplevel(py)
        n.title("Tkinter")
        ...
        def cal():
             subprocess.Popen(["python","photosk\\calc.py"])
        def code():
           subprocess.Popen(["notepad.exe","photosk\\calculator.txt"])
        def age():
             subprocess.Popen(["python","photosk\\GUI Age Calculator.py"])
        def code1():
             subprocess.Popen(["notepad.exe","photosk\\age.txt"])
        def xo():
             subprocess.Popen(["python","photosk\\xo.py"])
        def code2():
             subprocess.Popen(["notepad.exe","photosk\\xo.txt"])
        def roll():
             subprocess.Popen(["python","photosk\\roll.py"])
        def code3():
             subprocess.Popen(["notepad.exe","photosk\\roll.txt"])
        def tk():
             subprocess.Popen(["python","photosk\\T2S.py"])
        def code4():
             subprocess.Popen(["notepad.exe","photosk\\text.txt"])
        def pp():
             subprocess.Popen(["python","photosk\\password.py"])
        def code5():
             subprocess.Popen(["notepad.exe","photosk\\password.txt"])
        ...
        n.mainloop()
    def fourth():
         subprocess.Popen(["notepad.exe","photosk\\lecture4.txt"])
    def fifth():
         subprocess.Popen(["notepad.exe","photosk\\lecture5.txt"])
